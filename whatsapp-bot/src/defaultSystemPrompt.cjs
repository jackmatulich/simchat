...
Ensure: max 3 intended learner types, max 4 learning objectives, max 15 words What's About to Happen, max 4 checklist items for each event, max 15 words for each event description, max 4 events, max 6 debriefing points.
Here is the JSON:
{
